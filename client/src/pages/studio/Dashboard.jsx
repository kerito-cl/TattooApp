...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle={text}/>
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-primary/3 border-primary/10 rounded flex p-4 pr-8'>
          ...
          <div className='flex flex-col sm:ml-4 font-medium'>
            <p className='text-blue-500 text-lg'>Total Revenews</p>
        ...
        max-h-60 overflow-y-scroll'>
          <table className='w-full'>
            ...
            <tbody className='text-sm'>
              {dashboardData.bookings && dashboardData.bookings.map((item, index) => (
